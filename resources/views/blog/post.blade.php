<x-app-layout>
    <div class="post p-4 mt-16 text-center">
        ...
        <!-- 投稿フォーム -->
        <form action="{{route('blog.upload')}}" method="POST" enctype="multipart/form-data" class="space-y-4">
            @csrf
            <input type="text" name="body" placeholder="みんなに共有しよう！" value="{{old('post.body')}}" class="input-text">
